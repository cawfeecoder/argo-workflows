...
sensor-linux:
	CGO_ENABLED=0 GOOS=linux GOARCH=arm64 make sensor
...
sensor-controller-linux:
	CGO_ENABLED=0 GOOS=linux GOARCH=arm64 make sensor-controller
...
gateway-controller-linux:
	CGO_ENABLED=0 GOOS=linux GOARCH=arm64 make gateway-controller
...
gateway-client-linux:
	CGO_ENABLED=0 GOOS=linux GOARCH=arm64 make gateway-client
...
webhook-linux:
	CGO_ENABLED=0 GOOS=linux GOARCH=arm64 make webhook
...
calendar-linux:
	CGO_ENABLED=0 GOOS=linux GOARCH=arm64 make calendar
...
resource-linux:
	CGO_ENABLED=0 GOOS=linux GOARCH=arm64 make resource
...
artifact-linux:
	CGO_ENABLED=0 GOOS=linux GOARCH=arm64 make artifact
...
file-linux:
	CGO_ENABLED=0 GOOS=linux GOARCH=arm64 make file
...
nats-linux:
	CGO_ENABLED=0 GOOS=linux GOARCH=arm64 make nats
...
kafka-linux:
	CGO_ENABLED=0 GOOS=linux GOARCH=arm64 make kafka
...
amqp-linux:
	CGO_ENABLED=0 GOOS=linux GOARCH=arm64 make amqp
...
mqtt-linux:
	CGO_ENABLED=0 GOOS=linux GOARCH=arm64 make mqtt
...
storage-grid-linux:
	CGO_ENABLED=0 GOOS=linux GOARCH=arm64 make storage-grid
...
gitlab-linux:
	CGO_ENABLED=0 GOOS=linux GOARCH=arm64 make gitlab
...
github-linux:
	CGO_ENABLED=0 GOOS=linux GOARCH=arm64 make github
...
sns-linux:
	CGO_ENABLED=0 GOOS=linux GOARCH=arm64 make sns
...
pubsub-linux:
	CGO_ENABLED=0 GOOS=linux GOARCH=arm64 make pubsub
...
hdfs-linux:
	CGO_ENABLED=0 GOOS=linux GOARCH=arm64 make hdfs
...
sqs-linux:
	CGO_ENABLED=0 GOOS=linux GOARCH=arm64 make sqs
...
slack-linux:
	CGO_ENABLED=0 GOOS=linux GOARCH=arm64 make slack
